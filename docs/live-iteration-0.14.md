...
Forge 0.14 keeps Play Mode isolated while exposing a deliberate live-tuning bridge. Open **Runtime** during Play to inspect the active hierarchy, registered component fields, script and graph variables, recent graph values, global gravity, and per-system frame timings.

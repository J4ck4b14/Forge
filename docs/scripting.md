...
A script exports a default class with optional lifecycle methods. It can import Forge **types**, which are erased by TypeScript compilation. Runtime services arrive through ScriptContext:

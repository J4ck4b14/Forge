...
Forge 0.9.2 completed the full Windows certification sequence: clean dependency installation, formatting, strict typecheck, lint and package-boundary checks, all 106 automated tests, and both production builds. The 0.9.1 hotfix notes below remain as historical context for the defects that certification uncovered.

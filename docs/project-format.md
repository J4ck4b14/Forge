...
Release 0.8 adds the optional defaulted sprite `lit` field and registered `forge.light` component. Existing projects without lights render as before. This does not change the enclosing project schema version.

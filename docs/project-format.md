...
| 5               | Stable multi-behaviour slots and per-slot enabled state                              | v4 → v5 converts `forge.script` data   |
...
| 8               | Forge 0.13 2D authoring generation                                                   | v7 → v8 updates engine metadata        |
| 9               | Forge 0.14 live-iteration generation                                                 | v8 → v9 updates engine metadata        |
| 10              | Forge 0.15 game-feel generation                                                      | v9 → v10 updates engine metadata       |
| 11              | Forge 0.16 public-release and Interchange foundation                                 | v10 → v11 updates engine metadata      |

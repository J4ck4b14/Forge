...
import { compose } from '@forge/core';
import {
  Light2D,
  ShadowCaster2D,
  SpriteRenderer,
...
it('canonicalizes the briefly shipped camelCase shadow-caster id', () => {
  ...
  wall.components['forge.shadowCaster'] = wall.components[ShadowCaster2D.type]!;
  ...
  expect(canonical.components['forge.shadowCaster']).toBeUndefined();
});

...
import { EditorModel, NoteComponent, pivotDelta, getPath } from '@forge/editor';
import { ProjectStorage } from '../packages/editor/src/storage';
import { instantiateScene, serializeProject } from '@forge/serialization';
import { Rigidbody2D } from '@forge/physics2d';
describe('Milestone 1 acceptance', () => {
  ...
  it('applies safe runtime values while Play locks ordinary authoring', () => {
    ...
    expect(() =>
      e.applyRuntimeComponent(id, 'forge.transform', 'local.4', 10),

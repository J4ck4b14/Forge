...
**Milestones 0–7, Editor Quality, Developer Velocity, Visual Logic, and Game UI & Persistence are implemented.** Forge 0.12.0 adds accessible DOM-backed runtime UI, flexible screen layout, project-scoped save profiles and slots, migrations, autosave, achievements, and persistent game services. Existing projects migrate on load. It remains a development release with the documented scope below.

...
**Milestones 0–7, the Editor Quality pass and Developer Velocity are implemented.** Forge 0.10.0 adds composable behaviour slots, TRS-first transform authoring, indexed tags and queries, runtime prefab creation, signals, timers, tweens, pointer/camera coordinates and a visual Input Action editor. Existing 0.9 projects migrate on load. It remains a development release with the documented scope below.

...
try {
  ...
  const platform = (name, x, y, width, visible = true) => {
    ...
    component(id, 'forge.box-collider', { width, height: 26 });
  ...
  const uiText = (
    ...
    component(id, 'forge.ui-panel', { color: '#101924', opacity: 0.88 });
  ...
  m.change('Author Luminous Vault scene', () => {
    ...
    component(camera, 'forge.camera', { background: '#070d15', zoom: 1 });

...
try {
  ...
  for (const game of ['shooter', 'platformer', 'fighter']) {
    ...
    const light = (name, kind, x, y, values = {}) => {
      ...
      component(id, 'forge.light', { kind, ...values });
      return id;
    };
    ...
    m.change('Create scene', () => {
      ...
      component(camera, 'forge.camera', { zoom: 1, background: '#101820' });
      entity(
        'Backdrop',
        0,
        0,
      ...
      if (game !== 'fighter') {
        ...
        if (game === 'shooter') {
          ...
          component(player, 'forge.rigidbody');
          ...
          const floor = (name, x, y, w) => {
            ...
            component(id, 'forge.box-collider', { width: w, height: 24 });
        ...
        const behaviour = randomUUID();
        component(arena, 'forge.behaviours', {
          order: [behaviour],
          items: {
            [behaviour]: {
              id: behaviour,
        ...
        component(arena, 'forge.audio-source', {
          clip: assetIds['Audio/Action.wav'],
          volume: 0.3,
          bus: 'SFX',
        });
        ...
        for (let i = 0; i < 2; i++) {
          ...
          component(id, 'forge.animator', { controller });
          entity(
            `Hitbox ${i + 1}`,
            0,
            0,

...
Exporter changes must begin at the Interchange capability contract, preserve deterministic Forge GUID mappings, use the central coordinate profiles, and add golden mapping/diagnostic tests. Never silently omit a lowered item, write undocumented native serialization formats, or modify creator-owned target files.

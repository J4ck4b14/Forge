import { z } from 'zod';
import type { ComponentDefinition, World, Guid } from '@forge/core';
import type { AssetData } from '@forge/assets';
import { SPRITE_REGION_MIME } from '@forge/assets';
import type { EngineContext, System } from '@forge/runtime';
import { SpriteRenderer } from '@forge/renderer';
export const CLIP_MIME = 'application/x-forge-animation',
  CONTROLLER_MIME = 'application/x-forge-animator';

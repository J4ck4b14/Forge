...
import type { SignalService, System } from '@forge/runtime';
...
export class RuntimeUiSystem implements System, RuntimeUiService {
  ...
  start(): void {
    ...
    this.root.className = 'forge-game-ui';

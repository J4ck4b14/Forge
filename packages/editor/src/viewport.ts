...
import { BoxCollider2D, CircleCollider2D, CapsuleCollider2D } from '@forge/physics2d';
import type { LightingStats } from '@forge/renderer/pixi';
import { Perception2D } from '@forge/scripting';
import { compose, type Matrix2D } from '@forge/core';

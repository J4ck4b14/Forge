...
import { Behaviours } from '@forge/scripting';
import { Tags, TransformComponent, decompose } from '@forge/core';
        ...
        if (
          ...
          if (field.kind === 'asset') {
            for (const asset of model.project.assets) {
              const suitable =
                type === 'forge.animator'
                  ? asset.mime === 'application/x-forge-animator'

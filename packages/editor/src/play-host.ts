...
import { InputService, defaultInput } from '@forge/input';
import { defaultPhysics } from '@forge/physics2d';
import { instantiateScene, type ProjectData } from '@forge/serialization';

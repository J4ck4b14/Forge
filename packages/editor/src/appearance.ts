...
export function applyAppearance(value: EditorAppearance, persist = true): void {
  ...
  root.style.setProperty('--forge-accent', value.accent);
  root.style.setProperty('--forge-accent-text', accentText);
  root.style.setProperty('--forge-surface', value.surface);
  root.style.setProperty('--forge-surface-text', surfaceText);
  root.style.setProperty('--forge-panel', mix(value.surface, darkSurface ? '#ffffff' : '#000000', darkSurface ? 0.06 : 0.05));
  root.style.setProperty('--forge-panel-raised', mix(value.surface, darkSurface ? '#ffffff' : '#000000', darkSurface ? 0.11 : 0.09));
  root.style.setProperty('--forge-control', mix(value.surface, darkSurface ? '#ffffff' : '#000000', darkSurface ? 0.15 : 0.13));
  root.style.setProperty('--forge-border', mix(value.surface, darkSurface ? '#ffffff' : '#000000', darkSurface ? 0.24 : 0.22));
  root.style.setProperty('--forge-muted', mix(surfaceText, value.surface, 0.38));

import { z } from 'zod';
import type { ComponentDefinition } from '@forge/core';
...
/** Optional authoring/debug configuration for visibility-driven AI. Scripts remain in control of alert state. */
export const Perception2D: ComponentDefinition<PerceptionData> = {
  type: 'forge.perception',

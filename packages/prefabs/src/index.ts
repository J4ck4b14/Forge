import { z } from 'zod';
import { guid, GUID_PATTERN, type ComponentDefinition } from '@forge/core';
  ...
  path: z
    ...
    .refine(
      (p) =>
        ...
        !p.some((k) =>
          ['__proto__', 'constructor', 'prototype', 'forge.prefab'].includes(k),
        ),
...
export const PREFAB_MIME = 'application/x-forge-prefab';

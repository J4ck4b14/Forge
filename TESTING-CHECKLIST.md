# Forge Milestones 1–4: hands-on acceptance
...
- Click **Import JSON** and choose `examples/physics-playground/Playground.forge.json`.
...
- Your exported `.forge.json` if the problem depends on the project.

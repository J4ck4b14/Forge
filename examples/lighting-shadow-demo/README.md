...
Import `lighting-shadow-demo.forge.json` into Forge 0.9. This is an authoring/regression scene, not a replacement for the bundled platformer/fighter/shooter prototypes.

# Three playable Forge prototypes
...
| ------------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Signal Patrol | shooter/shooter.forge.json       | WASD/arrows move; Space/mouse fire right; destroy six drones; three hits lose; R restart                               |
| Lantern Steps | platformer/platformer.forge.json | A/D or arrows move; Space jump; collect four coins and reach the gate; checkpoint saves respawn; R restart             |
| Sparring Room | fighter/fighter.forge.json       | Two-player local: P1 A/D, Space jump, F attack, G guard; P2 arrows, Up jump, K attack, L guard; knockout and R rematch |
